...
import { FormState, ProjectInterface, SessionInterface } from "@/comman.types"
  ...
  return (
    ...
    <div className="flexStart form_image-container">
        ...
        {form.image && (
            <Image
            src={form?.image}
            className="sm:p-10 onject-contain z-20"
            alt="Project-poster"
            fill
            />
        )}
    ...
    placeholder="Showcase your description"
    setState={(value)=>
    ...
    placeholder="https://github.com/abcd1"
    setState={(value)=>
